    ...
    <b-card header-tag="header">
      <b-row slot="header">
        ...
        <b-col sm="2" class="my-1">
          <span class="title">订单号:{{catering.caterid}}</span>
        </b-col>
        <b-col sm="8" class="my-1 titleInfo">
          <span class="title" v-show="caterclose">&#8195;| 宴会名称:&#8195;{{catering.name}}</span>
          <span class="title" v-show="caterclose">&#8195;| 销售员:&#8195;{{catering.saleid_des}}</span>
        </b-col>
