      ...
      <b-row id="rowrow" style="font-size: 1rem;width:100%;padding-bottom: 0.5rem">
        <el-table
          ...
          <el-table-column
            ...
            width="100">
            <template slot-scope="scope">
                <b-button size="mini" title="删除" class="Cancel-button image-btn" type="danger" @click="deletel(scope.row)"></b-button>
                <b-button size="mini" title="保存" class="Delete-button image-btn" type="danger" @click="saveitem(scope.row)"></b-button>
